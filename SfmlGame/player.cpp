...
void player::moveCharacter()
{
		...
		if (Keyboard::isKeyPressed(Keyboard::Left)|| Keyboard::isKeyPressed(Keyboard::A)) {
			...
			getSprite().setTextureRect(IntRect(38 * int(CurrentFrame)+33, 474+ _armorType, -33, 45)); //проходимся по координатам Х. получается начинаем рисование с координаты Х равной 0,96,96*2, и опять 0
			...
			if (CurrentFrame > 5) CurrentFrame -= 5; // если пришли к третьему кадру - откидываемся назад.
			getSprite().setTextureRect(IntRect(38 * int(CurrentFrame), 474+ _armorType, 33, 45)); //проходимся по координатам Х. получается начинаем рисование с координаты Х равной 0,96,96*2, и опять 0
			...
			getSprite().setTextureRect(IntRect(41 * int(CurrentFrame), 746+ _armorType, 34, 45)); //проходимся по координатам Х. получается начинаем рисование с координаты Х равной 0,96,96*2, и опять 0
